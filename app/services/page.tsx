  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-start hover:scale-[1.025] hover:shadow-2xl transition-transform duration-300" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5 }}>
              ...
              <button onClick={() => { fetchCryptoRates(); setShowCryptoModal(true); }} className="mt-auto inline-block px-6 py-2 rounded-full bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition flex items-center gap-2"><FaBitcoin /> Crypto Calculator</button>
            </motion.div>
          </motion.div>
        </div>
        ...
        <AnimatePresence>
          {showTradeInModal && (
            <motion.div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" initial="hidden" animate="visible" exit="hidden" variants={modalVariants}>
              <motion.div className="bg-white rounded-xl shadow-xl p-8 max-w-lg w-full relative" initial="hidden" animate="visible" exit="exit" variants={modalVariants}>
        ...
        <AnimatePresence>
          {showShippingModal && (
            <motion.div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" initial="hidden" animate="visible" exit="hidden" variants={modalVariants}>
              <motion.div className="bg-white rounded-xl shadow-xl p-8 max-w-md w-full relative" initial="hidden" animate="visible" exit="exit" variants={modalVariants}>
