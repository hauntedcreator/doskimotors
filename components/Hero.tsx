        ...
        <div className="text-center">
          ...
          >
            <motion.span 
              ...
              className="inline-flex items-center rounded-full bg-blue-600/30 px-4 py-2 text-sm font-medium text-blue-100 ring-1 ring-inset ring-blue-400/50 mb-6 backdrop-blur-sm desktop-only"
            >
          ...
          >
            ...
            <div className="text-center group cursor-pointer hover:scale-105 transition-transform desktop-only">
              <div className="mb-2 relative">
          ...
          {/* Trust Badges - Modified for mobile */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1, delay: 1 }}
            className="mt-12 flex flex-wrap justify-center items-center gap-6 sm:gap-8 mobile-trust-badges"
          >
            <div 
              onClick={() => window.open('https://www.bbb.org/', '_blank')}
              className="group flex items-center gap-3 px-4 py-3 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300 cursor-pointer border border-white/10 hover:border-white/20 desktop-only"
            >
              <svg
            ...
            <div 
              onClick={scrollToTestimonials}
              className="group flex items-center gap-3 px-4 py-3 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300 cursor-pointer border border-white/10 hover:border-white/20 mobile-badge"
            >
              <svg
                className="w-8 h-8 text-blue-400 group-hover:text-blue-300 transition-colors"
                viewBox="0 0 24 24"
