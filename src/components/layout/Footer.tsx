    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Doski Motors</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/vehicles?type=new" className="text-gray-400 hover:text-white">
                  New Vehicles
                </Link>
              </li>
              <li>
                <Link href="/vehicles?type=used" className="text-gray-400 hover:text-white">
                  Used Vehicles
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>Email: info@doskimotors.com</p>
            </div>
          </div>
        </div>
